...
which can be done either with the 'true' strata information as described in (Chen et al.,2016), 
or with the first PCs (Milet and Perdry, 2020).
...
```{r qqplotsMLM, fig.height = 3, fig.width = 9, dev = 'png', cache = TRUE, dpi = 300}
...
```{r qqplotsMLR, fig.height = 3, fig.width = 9, dev = 'png', cache = TRUE, dpi = 300}
par(mfrow=c(1,3), cex = 0.7)
